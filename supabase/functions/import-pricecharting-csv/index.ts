...
const PRICECHARTING_CSV_URL = 'https://www.pricecharting.com/price-guide/download-custom?t=f8bc66d1b86abd89584e7ea12a3d8d6b788dedb9&category=pokemon-cards'
...
Deno.serve(async (req) => {
  ...
  const processTask = async () => {
    try {
        ...
        const response = await fetch(PRICECHARTING_CSV_URL)
        if (!response.ok) {
